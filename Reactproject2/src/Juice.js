...
function Juice() {
  ...
  const currentCards = juicedata.slice(indexOfFirstCard, indexOfLastCard);
  ...
  // const filtershop = shopdata.filter((item) => item.price >= minprice && item.price <= maxprice)
  return (
    <>
        ...
        <div className='col-lg-9'>
          <nav aria-label="breadcrumb" className='w2 mt-5 m-auto'>
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Juice</li>
            </ol>
          </nav>
          <p className='display-2 w2 m-auto fw-bold text-success'>Juice</p>
          ...
          <div className='w2 m-auto mt-5'>
            <span>Showing {indexOfFirstCard + 1}–{Math.min(indexOfLastCard, juicedata.length)} of {juicedata.length} results</span>
