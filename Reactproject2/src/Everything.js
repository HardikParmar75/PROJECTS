    ...
    <>
      <div className='row me-0 p-5 bg-light'>
        ...
        <div className='col-lg-9'>
          ...
          <p className='display-2 w2 m-auto fw-bold text-success'>Shop</p>
          <div className='w2 m-auto mt-5'>
            <span>Showing {indexOfFirstCard + 1}–{Math.min(indexOfLastCard, shopdata.length)} of {shopdata.length} results</span>
