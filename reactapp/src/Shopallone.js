...
function Shopallone() {
    ...
    var num = 1;
    var [d,setid] = useState(num)
    const [title, settitle] = useState('');
    const [price, setprice] = useState('');
    useEffect(() => {
        fetch('http://localhost:5000/shop/' + eid)
        ...
        <>
            ...
            <div className='row w2 m-auto mt-5'>
                ...
                <div className='col-md-6'>
                    ...
                    <button className='border-0 black text-light px-2 py-2' onClick={()=>{addtocart(`{eid}`)}}>ADD TO CART</button>
                </div>
            </div>
